package com.mostafayehya.deliciousrecipes;

import com.mostafayehya.deliciousrecipes.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoriesRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setSources("SimplyRecipes website");
